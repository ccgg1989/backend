...
var _products = _interopRequireDefault(require("../models/products.models"));
            ...
            return _products["default"].find().sort({
              ...
              if (Data.length === 0) {
                var _req$body = req.body,
                  nameproducts = _req$body.nameproducts,
                  ...
                  tags = _req$body.tags;
                var idproducts = 1;
                var newProducts = new _products["default"]({
                ...
                var value = results[0].idproducts;
                var _idproducts = value + 1;
                var _newProducts = new _products["default"]({
                  idproducts: _idproducts,
                  nameproducts: _nameproducts,
                  price: _price,
                ...
                var _savedProducts = _newProducts.save();
                _logger["default"].info(_savedProducts);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _products["default"].find({}).limit(100).then(function (results) {
...
var getProductsByDiscount = /*#__PURE__*/function () {
  ...
  return function getProductsByDiscount(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.getProductsByDiscount = getProductsByDiscount;
var putProductsById = /*#__PURE__*/function () {
  ...
  return function putProductsById(_x11, _x12) {
...
var deleteProductsById = /*#__PURE__*/function () {
  ...
  return function deleteProductsById(_x13, _x14) {
...
var deleteAllProducts = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return _products["default"].deleteMany({}).remove().then(function (results) {
  ...
  return function deleteAllProducts(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();
exports.deleteAllProducts = deleteAllProducts;
var insertExcelProducts = /*#__PURE__*/function () {
  ...
  return function insertExcelProducts(_x17, _x18) {
    return _ref9.apply(this, arguments);
  };
}();
exports.insertExcelProducts = insertExcelProducts;