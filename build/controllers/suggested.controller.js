...
var _suggestedModels = _interopRequireDefault(require("../models/suggested.models.js"));
...
var createSuggested = exports.createSuggested = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _suggestedModels["default"].find().sort({
            $natural: -1
            ...
            if (Data.length === 0) {
              ...
              var _newSuggested = new _suggestedModels["default"]({
...
var getAllSuggested = exports.getAllSuggested = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _suggestedModels["default"].find({}).then(function (results) {
...
var getSuggestedDiscount = exports.getSuggestedDiscount = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _suggestedModels["default"].find({
            discount: {
              $ne: null
            }
...
var getSuggestedByName = exports.getSuggestedByName = /*#__PURE__*/function () {
...
var getSuggestById = exports.getSuggestById = /*#__PURE__*/function () {
...
var putSuggestedById = exports.putSuggestedById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return _suggestedModels["default"].findOneAndUpdate({
...
var deleteSuggestedById = exports.deleteSuggestedById = /*#__PURE__*/function () {
...
var deleteAllSuggested = exports.deleteAllSuggested = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _suggestedModels["default"].deleteMany({}).remove().then(function (results) {
...
var insertExcelSuggested = exports.insertExcelSuggested = /*#__PURE__*/function () {
        ...
        case 0:
          try {
            ...
            for (i = 0; i < xlData.length; i++) {
              ...
              image = new_Data[8];
              tags = new_Data[9];
              newSuggested = new _suggestedModels["default"]({
                idsuggested: idsuggested,
                namesuggested: namesuggested,
                price: price,
                descriptions: descriptions,
