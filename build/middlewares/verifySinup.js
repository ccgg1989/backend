  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          _logger["default"].debug("The user already exists");
          _context.next = 8;
          return _userModel["default"].findOne({
        ...
        case 11:
          _logger["default"].debug("The email already exists");
          next();
        case 13:
        case "end":
...
var checkRolesExisted = exports.checkRolesExisted = function checkRolesExisted(req, res, next) {
  if (req.body.roles) {
    for (var i = 0; i < req.body.roles.length; i++) {
      if (!_roleModel.ROLES.includes(req.body.roles[i])) {
        _logger["default"].debug("Role ".concat(req.body.roles[i], " does not exists"));
